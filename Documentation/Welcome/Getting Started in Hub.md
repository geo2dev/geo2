...
You can use both the Geo2 web-based Hub and the mobile app, depending on your role and workflow. Both platforms support route planning and optimization, as well as order management. Geo2 Hub is designed for delivery businesses and teams that manage routes centrally. It enables transport managers and dispatchers to plan and optimize routes, manage drivers and vehicles, import data in bulk via Excel (CSV) and PDFs, view and manage multiple routes on a single map, access analytics, reports and route cost calculation, and use AI-powered route building.
...
![Screenshot 2026-08-27 at 10.51.43.png](/Documentation/attachments/mtb8yqgw-n3abhe6d.png)

![Screenshot 2026-08-27 at 10.52.00.png](/Documentation/attachments/mtb8ywlu-d3nw78e9.png)
...
![Screenshot 2026-08-27 at 10.53.59.png](/Documentation/attachments/mtb8zvsz-60zxjvgq.png)

![Screenshot 2026-08-27 at 10.54.07.png](/Documentation/attachments/mtb901pn-dar6uemz.png)

Next, you can select one of the following options to start working with Geo2 Hub:

- **Create route** (recommended). Add stops and plan your first route. Learn more about [Hub: Routes](Web-Based%20Hub/Hub_%20Routes/index.md).
...
- **Customize settings**. Add more depots and vehicles, create templates for recipient notifications. Explore your [Hub: Environment Settings](Web-Based%20Hub/Hub_%20Environment%20Settings/index.md).

![Screenshot 2026-08-27 at 10.54.19.png](/Documentation/attachments/mtb90dez-6rs1vbys.png)
...
- **Order management** (Hub and mobile app): Create unlimited orders each month, set time windows, assign them to routes, and view proof of delivery (POD) history in both the web Hub and mobile app. Use multi-address scanning, bulk address paste (via Paste list feature) and voice search in the mobile app for fast adding route stops. Use import from photos and PDFs both in Hub and the mobile app. 
- **Route planning** (Hub and mobile app): Build unlimited routes with up to 15 orders per route, optimize them with vehicle restrictions, adjust stops and timings, plan driver breaks. Review and manage route in a calendar view by vehicle or driver.
...
- **AI Assistant** (Hub and mobile app): Create and update orders and routes, import stops from photos, screenshots and PDFs, move stops between routes, optimize routes with or without required stop time windows, add, edit, and delete breaks, start and complete routes, navigate across the platform, get the list of routes planned for today, and receive step-by-step guidance on key features. Limited to 10 requests per day for Free and Pro level users.
