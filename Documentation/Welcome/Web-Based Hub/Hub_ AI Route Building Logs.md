...
sidebar_position: 14
description: "By pressing the Route building logs button at the header toolbar,
  you can access all Hub: AI Route Building sessions ran in your environment."
---
...
![Screenshot 2026-09-23 at 14.27.46.png](/Documentation/attachments/mue2w8az-mkden61x.png)
...
![Screenshot 2026-09-23 at 14.28.28.png](/Documentation/attachments/mue2x4pl-ij8b7241.png)
...
“Depot address geo-location is not sufficiently accurate” means that you might need to go to [Depots settings](https://help.geo2.com/web-based-hub/hub-environment-settings/hub-depots-settings) and check if your depot address was properly geocoded.

You can visualise generated route by pressing the `Map view` button - see [Hub: Map View](Hub_%20Map%20View.md).

![Screenshot 2026-09-23 at 14.29.09.png](/Documentation/attachments/mue2y0fq-xdqbgezf.png)
