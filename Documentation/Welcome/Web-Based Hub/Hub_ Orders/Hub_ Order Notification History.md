...
sidebar_position: 5
description: "If you have set up sending the Hub: Proof of Delivery Settings and
  Hub: Public Tracking Settings and an order has indicated the recipient email"
---
# Hub: Order Notification History

If you have set up sending the [Proof of delivery](../Hub_%20Environment%20Settings/Hub_%20Proof%20of%20Delivery%20Settings.md) and [Public tracking notifications](../Hub_%20Environment%20Settings/Hub_%20Public%20Tracking%20Settings.md) and an order has indicated the **recipient** **email address/mobile phone number**, you can then track the statuses of emails/SMS notifications on Notification history tab inside the Order details in Hub.
...
![Order_20250829_9.png](/Documentation/attachments/57eb5941-385a-4751-9f34-0b2b6b4a0ce5.png)
