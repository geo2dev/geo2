...
| **Setting** | **Description** |
| --- | --- |
| Default address country format | Address format to use when addresses are formatted as blocks of text, on-screen, and in PDF layouts.  If the country inside an order matches with the default address country format in Environment settings, we do not show the country field on the next pages: <br/>- Order card on Orders page in Hub <br>- Stop, route start/end and break cards on Route view page in Hub and the mobile app <br>- On Create/Edit route pages in the mobile app <br>- On Add/Edit stop pages in the mobile app <br>- Stop details page in the mobile app <br>- Create POD page in the mobile app <br>- Add/Update break modals in the mobile app <br>- Break page in the mobile app <br>- Route end page in the mobile app <br>- POD history and POD PDF |
