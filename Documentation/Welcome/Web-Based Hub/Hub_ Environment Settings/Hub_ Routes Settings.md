...
sidebar_position: 7
description: Route defaults from Settings → Environment → Routes are applied to
  routes when they are first created.
---
# Hub: Routes Settings
...
| **Setting** | **Description** |
| -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Route key autogeneration | Options used for automatic route key generation. For example, on Create route page or during AI route building, the route key can be autogenerated using the current date and time, trip number, and depot, depending on the selected settings. |
| Export orders on route status | Automatic export of orders assigned to a route once the route reaches the selected status. For example, if “Planned” is selected, orders will be exported when the route status changes from “Planning” to “Planned”. If “Manual” is selected, automatic export is disabled. |
...
![Screenshot 2026-08-31 at 13.27.05.png](/Documentation/attachments/mth6c9dz-67l5o8gk.png)
...
![Screenshot 2026-08-31 at 13.27.12.png](/Documentation/attachments/mth6cpcb-vu28z6sk.png)
